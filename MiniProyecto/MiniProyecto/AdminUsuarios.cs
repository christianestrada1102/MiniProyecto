...
namespace MiniProyecto
{
    public partial class AdminUsuarios : Form
    {
        ...
        //LEER y CARGAR TODOS LOS USUARIOS
        ...
        private void btnGuardar_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Por favor completa todos los campos para continuar", "Validación", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            {
                MessageBox.Show("ERROR! Por favor ingresa una edad válida", "Validación", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return;
            }
            ...
            else
            {
                ...
                {
                    MessageBox.Show("BIEN!!! Usuario actualizado correctamente", "Éxito", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    CargarUsuarios();
                    LimpiarCampos();
                    idSeleccionado = -1;
                }
        ...
        private void btnEliminar_Click(object sender, EventArgs e)
        {
            ...
            if (resultado == DialogResult.Yes)
            {
                ...
                {
                    MessageBox.Show("BIEN!!! Usuario eliminado correctamente", "Éxito", MessageBoxButtons.OK, MessageBoxIcon.Information);
                    CargarUsuarios();
                    LimpiarCampos();
                    idSeleccionado = -1;
                }
